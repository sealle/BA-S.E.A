  ...
  _createClass(SingleOtpInput, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          rest = _objectWithoutProperties(_props2, ['separator', 'isLastChild', 'inputStyle', 'focus', 'isDisabled', 'hasErrored', 'errorStyle', 'focusStyle', 'disabledStyle']);

      return _react2.default.createElement(
        'div',
        { style: { display: 'flex', alignItems: 'center' } },
        _react2.default.createElement('input', _extends({
          style: Object.assign({ width: '3rem', textAlign: 'center', height:"3rem", margin:"0px 1rem", fontSize:"2rem", borderRadius:"4px", border:"1px solid rgba(0,0,0,0.3)" }, inputStyle, focus && isStyleObject(focusStyle) && focusStyle, isDisabled && isStyleObject(disabledStyle) && disabledStyle, hasErrored && isStyleObject(errorStyle) && errorStyle),
