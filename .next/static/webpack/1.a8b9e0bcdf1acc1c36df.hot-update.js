    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startPeer", function (userId) {
      ...
      peer.on("stream", function (stream) {
        try {
          ...
          console.log(_this.currentUser.stream);
          console.log(stream); // const audioMixer = new MultiStreamsMixer([this.currentUser.stream, stream])

          var audioMixer = new multistreamsmixer__WEBPACK_IMPORTED_MODULE_18__["MultiStreamsMixer"]([_this.currentUser.stream, stream]);
          console.log(audioMixer); //start recording the audio line
  ...
  _createClass(Admin, [{
    ...
    value: function render() {
      ...
      react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_14__["Segment"], {
        ...
        hidden: true
      }, "Quit Call")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, this.state.isRecording)) : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_14__["Button"], {
        animated: true,
        floated: "left",
        onClick: this.takeSnapshot,
        style: {
...
//# sourceMappingURL=1.a8b9e0bcdf1acc1c36df.hot-update.js.map