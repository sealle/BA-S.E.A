  ...
  _createClass(VideoChat, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_9___default.a.post(window.location.origin + "/videochat/stream", {
                  timeout: 60 * 4 * 1000
                });
    ...
    value: function setupPusher() {
      ...
      channelName.bind("pusher:member_added", function (member) {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default()("You are conneted to", "".concat(member.id), "success"); // let newConnect = member.id;
      ...
      channelName.bind("pusher:member_removed", function (member) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default()("Removed member", "".concat(member.id), "success"); //reload admin page?
      });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_3__["default"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("style", null, "\n        body {\n          background: #e6e6e6;\n        }\n      "), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_8__["Segment"], {
        ...
        return _this5.currentUser.id !== userId && _this5.state.isNotCalled ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_8__["Button"], {
          icon: true,
          key: userId,
          onClick: function onClick() {
        ...
        }, "Call ", userId, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_8__["Icon"], {
          name: "phone"
        })) : null;
      ...
      })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), this.state.role == 1 ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_8__["Button"], {
      ...
      }, "end call") : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_8__["Button"], {
      ...
      }, "end call"), this.state.role == 1 ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_8__["Message"], {
        success: true,
...
function (_Component) {
  ...
  _createClass(VideoChatPage, [{
    ...
    value: function componentWillMount() {
      var token = Object(_utils_CookieUtils__WEBPACK_IMPORTED_MODULE_3__["getCookie"])("x-access-token");
