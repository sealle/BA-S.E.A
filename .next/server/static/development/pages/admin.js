...
/* harmony import */ var _components_VideoChat__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/VideoChat */ "./components/VideoChat.js");
...
function (_Component) {
  ...
  function adminPage() {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              if (response.data.success) {
                ...
                console.log("user declined"); //TODO: Quit VideoCall! How? Component where user is redirected to login?
              } else {
                console.log("error");
    ...
    _this.closeModal = _this.closeModal.bind(_assertThisInitialized(_assertThisInitialized(_this))); // this.closeModalAfterApproval = this.closeModalAfterApproval.bind(this);
  ...
  _createClass(adminPage, [{
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                function () {
                  ...
                  /*#__PURE__*/
                  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(err, result) {
    ...
    value: function () {
      var _selectUser = _asyncToGenerator(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(member, e, dimmer) {
    ...
    value: function render() {
      ...
      }) : null)), this.state.isVideo ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_VideoChat__WEBPACK_IMPORTED_MODULE_13__["default"], null) : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, this.state.users.map(function (member) {
