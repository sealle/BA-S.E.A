...
function (_Component) {
  ...
  function Assets() {
    ...
    _this.toAssets = _this.toAssets.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.toTerms = _this.toTerms.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.toPayment = _this.toPayment.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleCheckAssets1 = _this.handleCheckAssets1.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleCheckAssets2 = _this.handleCheckAssets2.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.handleCheck6 = _this.handleCheck6.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Assets, [{
    ...
    key: "handleCheckAssets1",
    value: function handleCheckAssets1() {
      ...
      this.setState({
        checkedAssets1: !this.state.checkedAssets1
      });
    }
  }, {
    key: "handleCheckAssets2",
    value: function handleCheckAssets2() {
      ...
      this.setState({
        checkedAssets2: !this.state.checkedAssets2
      });
    }
  }, {
    key: "handleCheck1",
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 6:
                ...
                return _ethereum_src_contract__WEBPACK_IMPORTED_MODULE_8__["default"].methods.payKYC().send({
                  from: accounts[0],
                  value: _ethereum_src_web3__WEBPACK_IMPORTED_MODULE_7__["default"].utils.toWei(this.state.value, "ether")
                });
