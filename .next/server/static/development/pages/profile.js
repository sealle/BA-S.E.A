    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Segment"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Form"].Group, {
          ...
          href: "../static/".concat(_this2.state.img2),
          target: "_blank"
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("img", {
          className: "img-responsive",
...
function (_Component) {
  ...
  function VideoChat() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "endCall",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(otp);
              _context.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_11___default.a.post(window.location.origin + "/otpVerify", {
                otp: otp
              });
  ...
  _createClass(VideoChat, [{
    ...
    value: function render() {
      ...
      }, "Submit") : null) : null, this.state.role == 1 && this.state.connectedTo ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Message"], {
        success: true,
