...
function (_Component) {
  ...
  function VideoChat() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleOnCropComplete1", function (crop, pixelCrop) {
      ...
      var canvasRef = _this.imagePreviewCanvasRef.current; // let image1 = "static/Admin-ScanBack.jpeg";
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              context.drawImage(img, 0, 0, 500, 300); // let snapshot = canvas.toDataURL("image/png");
